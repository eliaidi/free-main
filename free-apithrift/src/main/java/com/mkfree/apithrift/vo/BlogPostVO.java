 ...
 * 定义博客实体，用于接口传输
 */
public class BlogPostVO implements org.apache.thrift.TBase<BlogPostVO, BlogPostVO._Fields>, java.io.Serializable, Cloneable, Comparable<BlogPostVO> {
  ...
  public int compareTo(BlogPostVO other) {
    ...
    lastComparison = Boolean.valueOf(isSetReplies()).compareTo(other.isSetReplies());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReplies()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.replies, other.replies);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetPostsIp()).compareTo(other.isSetPostsIp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPostsIp()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.postsIp, other.postsIp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    lastComparison = Boolean.valueOf(isSetBlogNick()).compareTo(other.isSetBlogNick());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlogNick()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blogNick, other.blogNick);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetBlogCategory()).compareTo(other.isSetBlogCategory());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBlogCategory()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.blogCategory, other.blogCategory);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
