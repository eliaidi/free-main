 ...
 * 博客回复传输对象
 */
public class BlogCommentVO implements org.apache.thrift.TBase<BlogCommentVO, BlogCommentVO._Fields>, java.io.Serializable, Cloneable, Comparable<BlogCommentVO> {
  ...
  public int compareTo(BlogCommentVO other) {
    ...
    lastComparison = Boolean.valueOf(isSetReplyIp()).compareTo(other.isSetReplyIp());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetReplyIp()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.replyIp, other.replyIp);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
