 ...
 * 登录用户传输实体类
 */
public class SSOUserVO implements org.apache.thrift.TBase<SSOUserVO, SSOUserVO._Fields>, java.io.Serializable, Cloneable, Comparable<SSOUserVO> {
  ...
  public int compareTo(SSOUserVO other) {
    ...
    lastComparison = Boolean.valueOf(isSetTicketVaild()).compareTo(other.isSetTicketVaild());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTicketVaild()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.ticketVaild, other.ticketVaild);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
