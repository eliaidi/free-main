 ...
 * 用于分页传输对象
 */
public class PaginationVO implements org.apache.thrift.TBase<PaginationVO, PaginationVO._Fields>, java.io.Serializable, Cloneable {
  ...
  public int compareTo(PaginationVO other) {
    ...
    PaginationVO typedOther = (PaginationVO)other;
    ...
    lastComparison = Boolean.valueOf(isSetUpPage()).compareTo(typedOther.isSetUpPage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpPage()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.upPage, typedOther.upPage);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetNextPage()).compareTo(typedOther.isSetNextPage());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNextPage()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.nextPage, typedOther.nextPage);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
