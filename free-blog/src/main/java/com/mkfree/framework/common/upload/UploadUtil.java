...
public class UploadUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(util.getUploadPath("f:/opt/virtual/upload/", "blog/posts/", 10, 3));
	 ...
	 * 
	 * @param basePath
	 *            上传附件设定的路径,我的目录结构设置为/opt/virtual/upload/
	 * @param rootPath
	 *            应用上传文件的根目录 blog/posts/
	 * @param saveCount
	 *            一个目录保存多少文件
	 * @param dirLevel
	 *            目录层次
	 ...
	 *            父级目录
	 * @param nextDir
	 *            下级目录,例如 000/000/000/000 返回 000/000/000/001
	 * @return
	 */
	...
	public String getUploadFileName(String file) {
		...
		fileName.append(c.get(Calendar.YEAR)).append("-").append(c.get(Calendar.MONTH) + 1).append("-")
				.append(c.get(Calendar.DATE)).append("-").append(c.get(Calendar.HOUR_OF_DAY)).append("-")
	 ...
	 * @return
	 */
	private String getExpandedName(String file) {
